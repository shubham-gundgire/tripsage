...
export async function sendPasswordResetEmail(toEmail, userName, resetLink) {
  const subject = "Reset Your TripSage Password";
  const html = `
    <!DOCTYPE html>
    <html>
    <head>
      ...
      <title>Reset Your TripSage Password</title>
      <style>
        body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; }
        .container { max-width: 600px; margin: 0 auto; padding: 20px; }
        .header { background: linear-gradient(to right, #4f46e5, #7c3aed); padding: 20px; text-align: center; border-top-left-radius: 5px; border-top-right-radius: 5px; }
    ...
    <body>
      <div class="container">
        ...
        <div class="content">
          <p>Hello ${userName},</p>
          <p>We received a request to reset your password for your TripSage account. If you didn't make this request, you can safely ignore this email.</p>
          ...
          <p>${resetLink}</p>
          <p>Thank you for using TripSage!</p>
        </div>
        <div class="footer">
...
export async function sendWelcomeEmail(toEmail, userName) {
  const subject = "Welcome to TripSage!";
  const html = `
    <!DOCTYPE html>
    <html>
    <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Welcome to TripSage</title>
      <style>
        body { font-family: Arial, sans-serif; line-height: 1.6; color: #333; }
        .container { max-width: 600px; margin: 0 auto; padding: 20px; }
        .header { background: linear-gradient(to right, #4f46e5, #7c3aed); padding: 20px; text-align: center; border-top-left-radius: 5px; border-top-right-radius: 5px; }
        ...
        .feature { flex: 1; padding: 15px; text-align: center; }
    ...
    <body>
      <div class="container">
        <div class="header">
          <h1>Welcome to TripSage!</h1>
        </div>
        <div class="content">
          <p>Hello ${userName},</p>
          <p>Thank you for joining TripSage! We're excited to help you plan your next adventure.</p>
          
          <div class="features">
            <div class="feature">
              <h3>Discover</h3>
              <p>Explore amazing destinations and hidden gems around the world.</p>
            </div>
            <div class="feature">
              <h3>Plan</h3>
              <p>Create personalized travel itineraries with our expert recommendations.</p>
            </div>
            <div class="feature">
              <h3>Experience</h3>
              <p>Make memories that last a lifetime with unforgettable experiences.</p>
            </div>
          </div>
          
          <p style="text-align: center;">
            <a href="https://tripsage.vercel.app" class="button">Start Exploring</a>
          </p>
...
export async function sendHotelBookingConfirmation(toEmail, userName, bookingDetails) {
  ...
  try {
    ...
    To: ${toEmail}
    Subject: Your Hotel Booking Confirmation - TripSage
    ...
    - Total Price: ₹${parseFloat(bookingDetails.total_price).toLocaleString('en-IN')}
    
    Thank you for choosing TripSage!
    ===========================================================
    `);
    return Promise.resolve();
  }
...
export async function sendTravelBookingConfirmation(toEmail, userName, bookingDetails) {
  ...
  try {
    ...
    To: ${toEmail}
    Subject: Your Travel Package Confirmation - TripSage
    
    Hello ${userName},
    
    Thank you for booking the ${packageName} package!
