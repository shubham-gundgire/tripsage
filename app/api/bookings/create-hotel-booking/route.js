...
import { sendHotelBookingConfirmation } from '@/app/lib/emailService';
...
export async function POST(request) {
  try {
    ...
    try {
      await sendHotelBookingConfirmation(userEmail, userName, {
        ...data[0],
        hotel_details: hotelDetails // Pass the parsed hotel details
      });
      console.log('Hotel booking confirmation email sent successfully');
    } catch (emailError) {
