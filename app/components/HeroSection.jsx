  ...
  return (
    <div className="relative h-screen w-full">
      ...
      <div className="relative h-full flex flex-col items-center justify-center px-4 md:px-6">
        <div className="mb-12 md:mb-24 w-full max-w-7xl">
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-russo text-white text-center leading-tight mb-6 md:mb-8 tracking-wide font-black">
            Explore the World's
        ...
        {/* Search Bar */}
        <div className="w-full max-w-xl md:max-w-2xl md:backdrop-blur-md md:bg-white/10 rounded-full p-2 flex flex-col md:flex-row gap-3 font-opensans mx-4">
          {/* Place Input */}
